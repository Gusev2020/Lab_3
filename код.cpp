...
Массив для 3-его задания
  ...
  M1 = (int )malloc(100sizeof(int));
  for(int i=0; i=100;i++)
  {
    M1[i] = (int)malloc(100  sizeof(int));
  }

  M2 = (int )malloc(100sizeof(int));
  for(int i=0; i100;i++)
  {
    M2[i] = (int)malloc(100  sizeof(int));
  }

  M3 = (int )malloc(100sizeof(int));
  for(int i=0; i100;i++)
  {
    M3[i] = (int)malloc(100  sizeof(int));
  }

  M4 = (int )malloc(100sizeof(int));
  for(int i=0; i100;i++)
  {
    M4[i] = (int)malloc(100  sizeof(int));
  }

  M5 = (int )malloc(100sizeof(int));
  for(int i=0; i100;i++)
  {
    M5[i] = (int)malloc(100  sizeof(int));
  }

  M6 = (int )malloc(100sizeof(int));
  for(int i=0; i100;i++)
  {
    M6[i] = (int)malloc(100  sizeof(int));
  }

  G1 = (int )malloc(100sizeof(int));
  for(int i=0; i100;i++)
  {
    G1[i] = (int)malloc(100  sizeof(int));
  }

  G2 = (int )malloc(100sizeof(int));
  for(int i=0; i100;i++)
  {
    G2[i] = (int)malloc(100  sizeof(int));
  }

  G3 = (int )malloc(100sizeof(int));
  for(int i=0; i100;i++)
  {
  ...
  for(int i =0;i1;i++){
     ...
     scanf(%d,&t );
         ...
         if(aarr &&  tarr && a!=t)
		 {
           printf(Вы ввели правельные координатыn);

         }
		 else
		 {
           printf(Вы ввели не правельные координатыn);
             i--;
         }
    }

   printf(nn отождествления вершин n);
   Ver1( M1,  a,  t,  arr);
  ...
  printf(nnВыведем обьединеную матрицуn );
...
printf(nnВыведем пересечение матрицn );
...
printf(nnВыведем кольцевое сложение матрицn );
